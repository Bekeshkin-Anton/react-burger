...
export type TBurgerIngredientsActions = IGetDataAction | IGetDataFailedAction | IGetDataSuccessAction;
...
export const getDataSuccessAction = (data: IIngredient[]): IGetDataSuccessAction => ({
